            ...
            <div className="boardRow">
                {[...Array(BOARD_SIZE).keys()].map(col => (
                    <div className="boardCol">
                        <div className={"boardCell" + (this.props.board[row][col]? (this.props.board[row][col] === 'circle'? ' boardCellCircle' : ' boardCellCross'): '')} id={row + "-" + col} key={row + "-" + col} onClick={this.handleCellClick.bind(this, row, col)}></div>
                    </div>
                ))}
            </div>));
    }
